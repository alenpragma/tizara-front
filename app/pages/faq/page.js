...
const page = () => {
    ...
    return (
        <div className="max-w-container px-[10px] mx-auto pb-[50px]">
            <div className="py-[50px] md:py-[80px] " id="faq">
            <h4 className="text-[18px] md:text-[40px] mb-10 text-main-black font-bold text-white flex items-center justify-center">

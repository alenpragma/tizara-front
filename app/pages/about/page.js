  ...
  let keyFeatureData = [
    {
      ...
      title: "OUR MISSION",
      text: "Our mission is to pioneer innovative financial solutions within the cryptocurrency landscape.We aim to empower investors by providing comprehensive insights, cryptocurrency, capital stock market, fostering education and delivering tailored investment strategies. Subsequent Step:-  Public Blockchain Network, Decentralize Exchange, AI Incredible TIZARA Coin, World Wide Fiat Payment Gateway, TIZARA Digital Asset Management (TDAM).",
    },
    {
